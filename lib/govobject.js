...
GovObjectController.prototype.submitProposal = function(req, res) {
  var self = this;
  var parentHash = req.body.hexdata || req.params.hexdata;
  var revision = req.body.revision || req.params.revision;
  var time = req.body.time || req.params.time;
  var dataHex = req.body.dataHex || req.params.dataHex;
  var collateral = req.body.collateral || req.params.collateral;
